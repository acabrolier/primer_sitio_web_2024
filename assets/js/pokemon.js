...
$(document).on('mouseover', 'img', function () {
    ...
    $.getJSON(urlPokemon, function (dataPokemon) {
        ...
        let peso = `<h5 class="card-title fw-bold">Peso: </h5><p>${dataPokemon.weight / 10} kgs.</p><ul>`;
        $('#pokemon-peso').html(peso);

        let estatura = `<h5 class="card-title fw-bold">Estatura: </h5><p>${dataPokemon.height / 10} mts.</p><ul>`;
