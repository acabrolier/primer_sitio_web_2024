    ...
    $.getJSON(urlRestCountries, function (dataCountries) {
        ...
        for (let i = 0; i < dataCountries.length; i++) {
            ...
            <tr class="text-center">
               ...
               <td>
                  <img class="img-country" src="${dataCountries[i].flags.svg}" alt="Flag ${dataCountries[i].translations.spa.common}">
               </td>
               <td>
                  <img class="img-country" src=${(dataCountries[i].coatOfArms.svg) ? dataCountries[i].coatOfArms.svg : "assets/img/not_found.svg"} alt="Coat of arms ${dataCountries[i].translations.spa.common}">
               </td>
            </tr>
             `
        }
